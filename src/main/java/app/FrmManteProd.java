...
public class FrmManteProd extends JFrame {
	...
	public FrmManteProd() {
		...
		cboProveedores.setBounds(288, 102, 125, 22);
	...
	void listado() {
		...
		for (Producto u : lstProductos) {
			...
			imprimir("Nombre.....:" + u.getDes_prod());
			imprimir("Proveedor..:" + u.getIdproveedor() + " " +  u.getObjProveedor().getNombre_rs());
			imprimir("Categoria..:" + u.getIdcategoria() + " " +  u.getObjCategoria().getDescripcion());
			imprimir("--------------------------------");
		}
